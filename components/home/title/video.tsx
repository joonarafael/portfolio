...
const TitleVideo = () => {
	return (
		<div className="relative bg-gradient-to-t from-black to-purple-500 hidden lg:flex w-2/5 h-full shadow-md shadow-black/50 dark:shadow-purple-800 rounded-xl">
