...
const WORK: Work[] = [
	...
	},
	{
		...
		description:
			"A highly sophisticated calculator tool built with React and Next.js. The application is hosted on Cloudflare Pages. The application is a tool for mining engineers to create blasting circuit diagrams and calculate detonation delays. The application has a modern and responsive UI built with the Radix UI library. The application has been built based on a real client request (initial software requirements specification). The application involves many useful user tools, multiple layers of different analyzing calculations, and pathfinding algorithms to create accurate and safe blasting circuit diagrams.",
		skills: [
			{
				name: "GitHub Actions",
	...
	},
	{
		...
		description:
			"A completed Python desktop application built as an university assignment. The flag game is a local single-player game where the user has to guess the country of a flag. The game is built with Python and the Tkinter library. The game has five different game modes included, each with different pointing mechanisms, and a user-friendly UI. As an addition, the game tracks game history and calculates the user's lifelong statistics! During the development of this project, I learned a lot about the Python programming language in general, and especially I finally understood the importance of unit testing.",
		skills: [
			{
				name: "GitHub Actions",
				icon: "https://img.shields.io/badge/GitHub%20Actions-%232671E5.svg?style=for-the-badge&color=black&logo=githubactions",
